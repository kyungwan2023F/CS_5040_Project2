    ...
    extends TestCase
{
    ...
    public void testEmptyKeywords()
    {
        ...
        Seminar emptyKeywordSeminar = new Seminar(
            1002,
            "Empty Keywords",
            "20231002",
            60,
    ...
    public void testNullKeywords()
    {
        ...
        Seminar nullKeywordSeminar = new Seminar(
            1003,
            "Null Keywords",
            "20231003",
            90,
            ...
            400,
            nullKeywords,
            "Seminar with some null keywords");
    ...
    // ----------------------------------------------------------
    /**
     * Tests NegativeValues().
     */
    public void testNegativeValues()
    {
        Seminar negativeSeminar = new Seminar(
            1004,
            "Negative Values Seminar",
            "20231004",
            0,
            (short)-10,
            (short)-20,
            -100,
            new String[] { "Error", "Negative" },
    ...
    {
        Seminar emptyStringSeminar = new Seminar(
            1005,
            "",
            "",
            60,
    ...
    // ----------------------------------------------------------
    /**
     * Tests NullTitleAndDescription().
     */
    public void testNullTitleAndDescription()
    {
        Seminar nullTitleSeminar = new Seminar(
            1006,
            null,
            "20231005",
            60,
    ...
    public void testEquals()
    {
        ...
        Seminar testSeminar1 = new Seminar(
            1001,
            "AI Seminar",
            "20231001",
            90,
            ...
            testKeywords1,
            "AI technologies");
        Seminar testSeminar1Duplicate = new Seminar(
            1001,
            "AI Seminar Duplicate",
            "20231001",
            90,
            (short)10,
            (short)20,
            ...
            testKeywords1,
            "AI technologies");
        Seminar testSeminar2 = new Seminar(
            1002,
            "Blockchain Seminar",
            "20231002",
            120,
