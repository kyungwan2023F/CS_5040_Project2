...
public class BintreeInternalNodeTest extends TestCase {
    ...
    public void testSearchAtBoundary() {
        Seminar seminar5 = new Seminar(5, "Seminar 1", "2024-10-20", 60,
            (short)1, (short)0, 100, new String[] { "tech" }, "First Seminar");
        Seminar seminar6 = new Seminar(6, "Seminar 2", "2024-11-20", 60,
            (short)1, (short)2, 200, new String[] { "science" },
            "Second Seminar");
        Seminar seminar7 = new Seminar(7, "Seminar 3", "2024-12-20", 60,
            (short)2, (short)1, 300, new String[] { "math" }, "Third Seminar");
