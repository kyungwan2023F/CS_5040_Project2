...
public class ControllerTest extends TestCase {
    ...
    public void testControllerInsertSearch() {
        ...
        assertEquals("Overview of HPC and CSE Research at VT", controller
            .getKeywordTree().find("HPC").value().title());
        controller.searchByKeyword("CSC");
        assertNull(controller.getKeywordTree().find("CSC"));

        controller.searchById(1);
        assertEquals("Overview of HCI Research at VT", controller.getIdTree()
            .find(1).value().title());
